...
class category_spider(scrapy.Spider):
    ...
    def parse_four(self, response):
        ...
        type = response.xpath("//div[@id='specs-categories']/div[2]/div[1]/div[3]/div[1]").extract()

        if len(type):
            if type == ['<div class="specs-set-title">Exterior Dimensions</div>']:
        ...
        type1 = response.xpath("//div[@id='specs-categories']/div[2]/div[1]/div[4]/div[1]").extract()

        if len(type1):
            if type1 == ['<div class="specs-set-title">Exterior Dimensions</div>']:
                name = response.xpath("//div[@id='tcc3-global-container']/h1/text()").extract()
                if len(name):
                    item['name'] = name[0]
                ...
                name0 = response.xpath(
                    "//div[@id='specs-categories']/div[2]/div[1]/div[4]/div[2]/span[1]/text()").extract()
                if len(name0):
                    item['name0'] = name0[0]
                    item['number0'] = response.xpath(
                        "//div[@id='specs-categories']/div[2]/div[1]/div[4]/div[2]/span[2]/text()").extract()[0]
                else:
                    item['name0'] = 'NAA'
                    item['number0'] = 'NAA'
                ...
                if len(name1):
                    item['name1'] = name1[0]
                    item['number1'] = response.xpath(
                        "//div[@id='specs-categories']/div[2]/div[1]/div[4]/div[3]/span[2]/text()").extract()[0]

                name2 = response.xpath(
                    "//div[@id='specs-categories']/div[2]/div[1]/div[4]/div[4]/span[1]/text()").extract()
                if len(name2):
                    item['name2'] = name2[0]
                    item['number2'] = response.xpath(
                        "//div[@id='specs-categories']/div[2]/div[1]/div[4]/div[4]/span[2]/text()").extract()[0]

                name3 = response.xpath(
                    "//div[@id='specs-categories']/div[2]/div[1]/div[4]/div[5]/span[1]/text()").extract()
                if len(name3):
                    item['name3'] = name3[0]
                    item['number3'] = response.xpath(
                        "//div[@id='specs-categories']/div[2]/div[1]/div[4]/div[5]/span[2]/text()").extract()[0]

                name4 = response.xpath(
                    "//div[@id='specs-categories']/div[2]/div[1]/div[4]/div[6]/span[1]/text()").extract()
                if len(name4):
                    item['name4'] = name4[0]
                    item['number4'] = response.xpath(
                        "//div[@id='specs-categories']/div[2]/div[1]/div[4]/div[6]/span[2]/text()").extract()[0]

                name5 = response.xpath(
                    "//div[@id='specs-categories']/div[2]/div[1]/div[4]/div[7]/span[1]/text()").extract()
                if len(name5):
                    item['name5'] = name5[0]
                    item['number5'] = response.xpath(
                        "//div[@id='specs-categories']/div[2]/div[1]/div[4]/div[7]/span[2]/text()").extract()[0]

                name6 = response.xpath(
                    "//div[@id='specs-categories']/div[2]/div[1]/div[4]/div[8]/span[1]/text()").extract()
                if len(name6):
                    item['name6'] = name6[0]
                    item['number6'] = response.xpath(
                        "//div[@id='specs-categories']/div[2]/div[1]/div[4]/div[8]/span[2]/text()").extract()[0]

                yield item


        type2 = response.xpath("//div[@id='specs-categories']/div[2]/div[1]/div[2]/div[1]").extract()

        if len(type2):
            if type2 == ['<div class="specs-set-title">Exterior Dimensions</div>']:
                name = response.xpath("//div[@id='tcc3-global-container']/h1/text()").extract()
                if len(name):
                    item['name'] = name[0]
